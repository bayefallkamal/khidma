...
describe('Service Tests', () => {
    ...
    describe('PaiementMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PaiementMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/paiements';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PaiementMySuffix', () => {
